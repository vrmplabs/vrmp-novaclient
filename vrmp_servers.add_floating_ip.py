...
if createip == 'y':
    ...
    # get pool
    pool = raw_input("Please enter the pool:")
    ...
    if listlen == 0:
        print "VRMP_warn: No floating ip to be allocated, system has exit."
        exit()
...
print "VRMP_info: Allocate floating ip completed successfully."
